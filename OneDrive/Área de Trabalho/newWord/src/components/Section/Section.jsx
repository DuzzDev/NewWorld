    ...
    <>
      <section className="conteiner">
        ...
        <p className="text">
            ...
            We had a responsibility to forge a future for humanity.  
        </p>
      </section>
      <section className="conteiner">
        <div>
      ...
      <section className="conteiner">
        ...
        <p className="text">
            Due to the proximity of Anydrus and its star, gravity caused the planet to have a slower rotation movement, causing bipolarity on the planet. A region of the planet was completely illuminated for 2.5 days and then completely dark for another 2.5 days, completing a rotation cycle.
      ...
      <section className="conteiner">
        ...
        <p className="text">
            ...
            due to the difference in temperature between the regions of luxis and tenebris, they became essential to control the planet's climate.
        </p>
      </section>
      <section className="conteiner">
        <div>
